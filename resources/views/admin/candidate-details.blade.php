    ...
    <div class="d-flex justify-content-center">
        <div class="flex-shrink-0">
            @if (session('user') && session('user')->profile_photo_path)
                <img src="{{ asset('storage/profile_photos') . '/' . session('user')->profile_photo_path }}"
...
<style>
                            ...
                            <table id="datatables-reponsive" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($value['assign_to'] == '0')
                                                    <a href="#" class="btn btn-primary assign-btn"
                                                        data-bs-toggle="modal" data-id="{{ $value['id'] }}"
                                                        data-bs-target="#assignCandidateModal">
                                                        Assign Candidate
                                                    </a>
                                                @else
                                                ...
                                                <button type="button" class="btn btn-info view-btn"
                                                    ...
                                                    data-reference_name="{{ $value['reference_name'] }}"
                                                    data-reference_phone="{{ $value['reference_phone'] }}"
                                                    data-organization_name="{{ $value['organization_name'] }}"
                                                    data-position_name="{{ $value['position_name'] }}"
                                                    data-notice_period="{{ $value['notice_period'] }}"
                                                    data-expected_date="{{ $value['expected_date'] }}"
                                                    data-current_ctc="{{ $value['current_ctc'] }}"
                                                    data-expected_ctc="{{ $value['expected_ctc'] }}"
                                                    data-strengths="{{ $value['strengths'] }}"
                                                    data-weaknesses="{{ $value['weaknesses'] }}"
                                                    data-career_goal="{{ $value['career_goal'] }}"
                                                    data-position_responsibilities="{{ $value['position_responsibilities'] }}"
                                                    data-areas_of_expertise="{{ $value['areas_of_expertise'] }}"
                                                    data-improve_your_knowledge="{{ $value['improve_your_knowledge'] }}"
                                                    data-service_are_we_providing="{{ $value['service_are_we_providing'] }}"
                                        ...
                                        <tr class="candidate-details" id="details-{{ $value['id'] }}"
                                            style="display: none;">
                                            <td colspan="6">
                                                <div class="card shadow-sm rounded" style="background-color: #f9f9f9;">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>Name: <span id="detail-name-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Email: <span id="detail-email-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Phone: <span id="detail-phone-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Address: <span id="detail-address-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>Designation: <span
                                                                        id="detail-designation-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Experience: <span
                                                                        id="detail-experience-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Reference Name: <span
                                                                        id="detail-reference_name-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Reference Phone: <span
                                                                        id="detail-reference_phone-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>Organization Name: <span
                                                                        id="detail-organization_name-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Position Name: <span
                                                                        id="detail-position_name-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Notice Period: <span
                                                                        id="detail-notice_period-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Expected Date: <span
                                                                        id="detail-expected_date-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>Current CTC (LPA): <span
                                                                        id="detail-current_ctc-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Expected CTC (LPA): <span
                                                                        id="detail-expected_ctc-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Strengths: <span
                                                                        id="detail-strengths-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Weaknesses: <span
                                                                        id="detail-weaknesses-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>Career Goal: <span
                                                                        id="detail-career_goal-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Position Responsibilities: <span
                                                                        id="detail-position_responsibilities-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>Areas of Expertise: <span
                                                                        id="detail-areas_of_expertise-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Improve Your Knowledge: <span
                                                                        id="detail-improve_your_knowledge-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>Service We Are Providing: <span
                                                                        id="detail-service_are_we_providing-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>Reason for Leaving: <span
                                                                        id="detail-reason_for_leaving-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                                <p>Reason for Applying: <span
                                                                        id="detail-reason_for_applying-{{ $value['id'] }}"
                                                                        class="text-dark"></span></p>
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade" id="assignCandidateModal" tabindex="-1" aria-labelledby="assignCandidateModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        ...
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById(`detail-position_responsibilities-${id}`).textContent =
                    positionResponsibilities;
                document.getElementById(`detail-areas_of_expertise-${id}`).textContent = areasOfExpertise;
                document.getElementById(`detail-improve_your_knowledge-${id}`).textContent =
                    improveKnowledge;
                document.getElementById(`detail-service_are_we_providing-${id}`).textContent =
                    serviceProviding;
                ...
                detailsRow.style.display = (detailsRow.style.display === 'none' || detailsRow.style
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    const deleteUrl = '{{ route('admin/delete-candidate-details', ':id') }}'
