                       ...
                       <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('emp/delete-leave-type', $leavetype->id)}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-3">
                <form method="POST" action="{{ route('emp/add-leavetype') }}" id="cardForm" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<script>
   $(document).ready(function() {
    $('.edit-leave-type-btn').click(function() {
        ...
        $('#leaveTypeForm').attr('action', '{{ route("emp/edit-leave-type") }}');
    ...
    $('#defaultModalSuccess').on('hidden.bs.modal', function () {
        ...
        $('#leaveTypeForm').attr('action', '{{ route("emp/add-leavetype") }}');
