                                        ...
                                        @if($leave->status == 0)
                                            <div class="dropdown mt-4">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('emp/leave-delete', $leave->id) }}" class="dropdown-item text-danger">Delete</a>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="modal fade" id="rejectModal{{ $leave->id }}" tabindex="-1" aria-labelledby="rejectModalLabel{{ $leave->id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('emp/leave-update', $leave->id) }}" method="POST">
                                                                @csrf
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    leaveModal.addEventListener('show.bs.modal', function (event) {
        ...
        var actionUrl = "{{ route('emp/leave-update', ':id') }}".replace(':id', leaveId);
