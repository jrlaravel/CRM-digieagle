            ...
            <div class="col-12">    
                <div class="card">
                    <div class="col-12 d-flex flex-column flex-sm-row justify-content-between align-items-center text-center text-sm-start flex-wrap">
                        <img src="{{ asset('storage/logo/Digieagle-Favicon.png') }}" class="mb-3 mb-sm-0" width="150px" alt="Logo">
                           ...
                           <div class="row">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="reference_name" name="reference_name" placeholder="Enter reference name" >
                                    </div>
                                    
                                    <div class="mb-3 col-md-6">
                                        <label for="">Reference Phone (If any):</label>
                                        <input type="number" class="form-control" id="reference_phone" max="10" name="reference_phone" placeholder="Enter reference phone" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                ...
                                <div class="row">   
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <textarea name="strengths" id="" cols="30" rows="10" class="form-control" placeholder="Enter strength"></textarea>
                                        @error('strengths')
                                        <span class="text-danger">{{ $message }}</span> 
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <textarea name="weaknesses" id="" cols="30" rows="10" class="form-control" placeholder="Enter weakness"></textarea>
                                        @error('weaknesses')    
                                        <span class="text-danger">{{ $message }}</span> 
                                        @enderror
                                    </div>
