                                    ...
                                    <td colspan="6">
                                        <div class="card shadow-sm rounded" style="background-color: #f9f9f9;">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p><strong>Name:</strong> <span id="detail-name-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Email:</strong> <span id="detail-email-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Phone:</strong> <span id="detail-phone-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Address:</strong> <span id="detail-address-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p><strong>Designation:</strong> <span id="detail-designation-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Experience:</strong> <span id="detail-experience-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Reference Name:</strong> <span id="detail-reference_name-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Reference Phone:</strong> <span id="detail-reference_phone-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p><strong>Organization Name:</strong> <span id="detail-organization_name-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Position Name:</strong> <span id="detail-position_name-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Notice Period:</strong> <span id="detail-notice_period-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Expected Date:</strong> <span id="detail-expected_date-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p><strong>Current CTC (LPA):</strong> <span id="detail-current_ctc-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Expected CTC (LPA):</strong> <span id="detail-expected_ctc-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Strengths:</strong> <span id="detail-strengths-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Weaknesses:</strong> <span id="detail-weaknesses-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p><strong>Career Goal:</strong> <span id="detail-career_goal-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Position Responsibilities:</strong> <span id="detail-position_responsibilities-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p><strong>Areas of Expertise:</strong> <span id="detail-areas_of_expertise-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Improve Your Knowledge:</strong> <span id="detail-improve_your_knowledge-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p><strong>Service We Are Providing:</strong> <span id="detail-service_are_we_providing-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p><strong>Reason for Leaving:</strong> <span id="detail-reason_for_leaving-{{ $value['id'] }}" class="text-muted"></span></p>
                                                        <p><strong>Reason for Applying:</strong> <span id="detail-reason_for_applying-{{ $value['id'] }}" class="text-muted"></span></p>
                                                    </div>
                                                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                const deleteUrl = '{{ route("emp/delete-candidate-details", ":id") }}'.replace(':id', candidateId);
