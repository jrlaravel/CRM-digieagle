                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('emp/delete-card',$card->id)}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-3">
                <form method="POST" action="{{ route('emp/add-card') }}" id="cardForm" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<script>
    ...
    $('.edit-card-btn').click(function() {
        ...
        $('#cardForm').attr('action', '{{ route("emp/update-card") }}');
    ...
    $('#defaultModalSuccess').on('hidden.bs.modal', function () {
        ...
        $('#cardForm').attr('action', '{{ route("emp/add-card") }}');
