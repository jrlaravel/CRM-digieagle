...
class HrCardsController extends Controller
{
    public function index()
    {
        $data = Card::all();  
       
        return view('employee/cards',compact('data'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('employee/cards')->with('success', 'Card deleted successfully.');
    }
    ...
    public function assign_card()
    {
        ...
        return view('employee/assign-card',compact('data','card','assigncard'));
    }
