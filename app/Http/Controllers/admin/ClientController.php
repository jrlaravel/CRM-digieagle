...
class ClientController extends Controller
{
    ...
    public function hosting_data_store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'domain_purchase_from' => 'required|string|max:255',
            'domain_purchase_date' => 'required|date|before_or_equal:today',
            'domain_expire_date' => 'required|date|after:domain_purchase_date',
            'domain_amount' => 'required|numeric|min:0',
            'domain_email' => 'nullable|email|max:255',
            'domain_id' => 'nullable|string|max:255',
            'domain_password' => 'required|string|max:255',
            'hosting_purchase_from' => 'required|string|max:255',
            'hosting_link' => 'required|url|max:255|unique:hosting_and_domain,hosting_link',
            'hosting_purchase_date' => 'required|date|before_or_equal:today',
            'hosting_expire_date' => 'required|date|after:hosting_purchase_date',
            'hosting_amount' => 'required|numeric|min:0',
